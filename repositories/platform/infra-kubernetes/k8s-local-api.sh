...
METALLB_INSTALL_YAML=./config/metallb-0.12.1.yaml

# MetalLB configmap configuration ready for envsubst
METALLB_POOLCONFIG_YAML=./templates/metallb-poolconfig.yaml
...
METRICS_SERVER_INSTALL_YAML=./config/metrics-server-0.6.3.yaml
